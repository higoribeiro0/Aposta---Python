...
class Sorteio:
    def __init__(self):
        ...
        self.frutas = ['Laranja', 'Limão', 'Manga', 'Banana', 'Melão', 'Abacate', 'Uva', 'Maçã', 'Pitomba', 'Acerola','Goiaba',
                'Siriguela', 'Cajá', 'Cupuaçu', 'Pera', 'Jabuticaba', 'Caju', 'Tangerina', 'Framboesa', 'Açaí','Amora','Araticum',
                'Bacaba', 'Biribá', 'Cacau', 'Caqui', 'Carambola', 'Cereja', 'Coco', 'Cupuaçu', 'Figo', 'Groselha','Jaca', 'Kiwi', 'Maracujá']
        self.frutasArray = []
